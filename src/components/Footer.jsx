        ...
        <footer id="contact" className="footer">
            <div className="footer-content">
                ...
                <div>
                    ...
                    <ul className="footer-links">
                        <li><a href="mailto:doppio.designtech@gmail.com" style={{ color: 'inherit', textDecoration: 'none' }}>doppio.designtech@gmail.com</a></li>
                        <li>São Paulo, SP</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="footer-bottom">
                ...
                <div className="social-links">
                    <a href="https://www.instagram.com/doppio.codesign?igsh=dnNua2FuOWNyZGZo" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Instagram">
